...
class TransportationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transportation" do
    assert_difference('Transportation.count') do
      post transportations_url, params: { transportation: { day: @transportation.day, direction: @transportation.direction, month: @transportation.month, note: @transportation.note, status: @transportation.status, year: @transportation.year } }
    end
  ...
  test "should update transportation" do
    patch transportation_url(@transportation), params: { transportation: { day: @transportation.day, direction: @transportation.direction, month: @transportation.month, note: @transportation.note, status: @transportation.status, year: @transportation.year } }
